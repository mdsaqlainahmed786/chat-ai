import { MessageCircle, Twitter, Github, Linkedin, Mail, Sparkles } from "lucide-react";
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center mb-6">
              ...
              <h3 className="text-2xl font-bold">AIChat Pro</h3>
            </div>
            <p className="text-gray-300 mb-6 leading-relaxed">
              Transform your team conversations with the power of Gemini 2.0. 
              Real-time AI assistance that makes every chat smarter and more productive.
            </p>
        ...
        <div className="py-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="mb-4 md:mb-0">
              <h4 className="font-semibold text-white mb-2">Stay in the loop</h4>
