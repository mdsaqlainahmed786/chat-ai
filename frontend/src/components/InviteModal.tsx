  ...
  const handleShare = async () => {
    ...
    try {
      ...
      await navigator.share({
        ...
        text: `Hi — I'd like to start a chat with you. Open this link to join:`,
        url: invite.url,
      });
    } catch (err) {
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-xl overflow-hidden">
          ...
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 rounded-full overflow-hidden bg-gradient-to-br from-purple-400 to-purple-600 flex items-center justify-center text-white font-semibold">
              {currentUser?.firstName
                ...
                : (currentUser?.clerkId ?? "U").slice(0, 1).toUpperCase()}
            </div>
            <div>
        ...
        <div className="p-6 space-y-4">
          <div className="text-sm text-gray-700">
            <strong>Important:</strong>This will be your Invite link. Only send
            this link to someone you trust. When the invitee can access the
            link, they will see your name and profile picture and will be able
            to start a conversation with you. Do not share this link publicly.
          </div>
